...
def get_response(text, systemprompt=
                ...
                Keep your responses relatively short (1 moderate paragraph max) unless otherwise specified by the user. This is the allow the user to pinpoint specifically what they are confused about.
